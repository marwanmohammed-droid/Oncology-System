...
const ROLE_ROUTES: Record<UserRole, string[]> = {
  admin: ['*'],
  doctor: ['/dashboard', '/patients', '/chemo-sessions', '/protocols', '/clinical-trials', '/lab-results', '/imaging', '/appointments', '/billing', '/insurance', '/inventory', '/treatment-plans', '/medical-report', '/reports', '/registry'], nurse: ['/dashboard', '/patients', '/chemo-sessions', '/appointments', '/inventory', '/medical-report'],
